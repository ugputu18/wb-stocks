    ...
    <section class="panel filters-panel">
      <form class="controls" onSubmit={onSubmit}>
        <div class="filters-primary-row">
          ...
          <label class="grow filter-search">
            Поиск
            <input
              type="search"
        ...
        <div class="quick-filters" role="group" aria-label="Быстрые фильтры (режим system)">
          <span class="quick-filters-label muted">Быстрый фокус</span>
          <div class="quick-filters-buttons">
            <button
              type="button"
              class={`quick-filter-btn${quickActive.all ? " is-active" : ""}`}
            ...
            <button
              type="button"
              class={`quick-filter-btn${quickActive.systemRisk ? " is-active" : ""}`}
            ...
            <button
              type="button"
              class={`quick-filter-btn${quickActive.wbReplenish ? " is-active" : ""}`}
            ...
            <button
              type="button"
              class={`quick-filter-btn${quickActive.supplierOrder ? " is-active" : ""}`}
            ...
            <button
              type="button"
              class={`quick-filter-btn${quickActive.deficitArrival ? " is-active" : ""}`}
        ...
        <details class="calc-params-details">
          <summary class="calc-params-summary">
            Параметры расчёта (покрытие, LT, безопасный запас, склад own, токен)
          </summary>
          <div class="calc-params-body">
            <div class="row calc-params-grid">
              <label>
                <LabelWithInlineHelp>
                  targetCoverageDays
