...
export async function buildForecastSnapshot(
  ...
  for (const d of demandRows) {
    ...
    records.push({
      ...
      forecastDailyDemand: d.forecastDailyDemand,
      demandModelVersion: d.demandModelVersion,
      rawAvgDaily7: d.rawAvgDaily7,
      rawAvgDaily30: d.rawAvgDaily30,
      rawAvgDaily90: d.rawAvgDaily90,
      adjustedAvgDaily7: d.adjustedAvgDaily7,
      adjustedAvgDaily30: d.adjustedAvgDaily30,
      adjustedAvgDaily90: d.adjustedAvgDaily90,
      sellableDays7: d.sellableDays7,
      sellableDays30: d.sellableDays30,
      sellableDays90: d.sellableDays90,
      constrainedDays7: d.constrainedDays7,
      constrainedDays30: d.constrainedDays30,
      constrainedDays90: d.constrainedDays90,
      availabilityObservedDays7: d.availabilityObservedDays7,
      availabilityObservedDays30: d.availabilityObservedDays30,
      availabilityObservedDays90: d.availabilityObservedDays90,
      peakDailyDemand: d.peakDailyDemand,
      forecastAllocationScale: d.forecastAllocationScale,
      stockSnapshotAt,
      startStock,
