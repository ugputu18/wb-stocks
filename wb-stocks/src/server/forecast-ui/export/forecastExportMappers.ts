...
export const WB_EXPORT_COLUMNS = [
  ...
  "raw_avg_daily_30",
  "raw_avg_daily_90",
  "adjusted_avg_daily_7",
  "adjusted_avg_daily_30",
  "adjusted_avg_daily_90",
  "sellable_days_7",
  "sellable_days_30",
  "sellable_days_90",
  "constrained_days_7",
...
export const WB_TOTAL_EXPORT_COLUMNS = [
  ...
  "demand_model_version",
  "raw_avg_daily_7_total",
  "raw_avg_daily_30_total",
  "raw_avg_daily_90_total",
  "adjusted_avg_daily_7_total",
  "adjusted_avg_daily_30_total",
  "adjusted_avg_daily_90_total",
  "constrained_days_7_max",
  "constrained_days_30_max",
  "constrained_days_90_max",
  "availability_observed_days_7_max",
  "availability_observed_days_30_max",
  "availability_observed_days_90_max",
  "peak_daily_demand_total",
  "forecast_allocation_scale_max",
  "recommended_to_wb",
...
export function wbTotalRowsToExportObjects(
  ...
  return rows.map((row) => ({
    ...
    demand_model_version: row.demandModelVersion ?? "",
    raw_avg_daily_7_total: row.rawAvgDaily7 ?? "",
    raw_avg_daily_30_total: row.rawAvgDaily30 ?? "",
    raw_avg_daily_90_total: row.rawAvgDaily90 ?? "",
    adjusted_avg_daily_7_total: row.adjustedAvgDaily7 ?? "",
    adjusted_avg_daily_30_total: row.adjustedAvgDaily30 ?? "",
    adjusted_avg_daily_90_total: row.adjustedAvgDaily90 ?? "",
    constrained_days_7_max: row.constrainedDays7 ?? "",
    constrained_days_30_max: row.constrainedDays30 ?? "",
    constrained_days_90_max: row.constrainedDays90 ?? "",
    availability_observed_days_7_max: row.availabilityObservedDays7 ?? "",
    availability_observed_days_30_max: row.availabilityObservedDays30 ?? "",
    availability_observed_days_90_max: row.availabilityObservedDays90 ?? "",
    peak_daily_demand_total: row.peakDailyDemand ?? "",
    forecast_allocation_scale_max: row.forecastAllocationScale ?? "",
...
export function wbReportRowsToExportObjects(
  ...
  return rows.map((row) => ({
    ...
    demand_model_version: row.demandModelVersion ?? "",
    raw_avg_daily_7: row.rawAvgDaily7 ?? "",
    raw_avg_daily_30: row.rawAvgDaily30 ?? "",
    raw_avg_daily_90: row.rawAvgDaily90 ?? "",
    adjusted_avg_daily_7: row.adjustedAvgDaily7 ?? "",
    adjusted_avg_daily_30: row.adjustedAvgDaily30 ?? "",
    adjusted_avg_daily_90: row.adjustedAvgDaily90 ?? "",
    sellable_days_7: row.sellableDays7 ?? "",
    sellable_days_30: row.sellableDays30 ?? "",
    sellable_days_90: row.sellableDays90 ?? "",
    constrained_days_7: row.constrainedDays7 ?? "",
    constrained_days_30: row.constrainedDays30 ?? "",
    constrained_days_90: row.constrainedDays90 ?? "",
    availability_observed_days_7: row.availabilityObservedDays7 ?? "",
    availability_observed_days_30: row.availabilityObservedDays30 ?? "",
    availability_observed_days_90: row.availabilityObservedDays90 ?? "",
    peak_daily_demand: row.peakDailyDemand ?? "",
    forecast_allocation_scale: row.forecastAllocationScale ?? "",
