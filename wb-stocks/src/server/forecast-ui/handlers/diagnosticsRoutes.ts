      ...
      handle: (req, res, url) => {
        ...
        json(res, 200, {
          ...
          rows: rows.map((r) => ({
            ...
            demandModelVersion: r.demandModelVersion,
            rawAvgDaily7: r.rawAvgDaily7,
            rawAvgDaily30: r.rawAvgDaily30,
            rawAvgDaily90: r.rawAvgDaily90,
            adjustedAvgDaily7: r.adjustedAvgDaily7,
            adjustedAvgDaily30: r.adjustedAvgDaily30,
            adjustedAvgDaily90: r.adjustedAvgDaily90,
            sellableDays7: r.sellableDays7,
            sellableDays30: r.sellableDays30,
            sellableDays90: r.sellableDays90,
            constrainedDays7: r.constrainedDays7,
            constrainedDays30: r.constrainedDays30,
            constrainedDays90: r.constrainedDays90,
            availabilityObservedDays7: r.availabilityObservedDays7,
            availabilityObservedDays30: r.availabilityObservedDays30,
            availabilityObservedDays90: r.availabilityObservedDays90,
            peakDailyDemand: r.peakDailyDemand,
            forecastAllocationScale: r.forecastAllocationScale,
          })),
        });
      },
    },
